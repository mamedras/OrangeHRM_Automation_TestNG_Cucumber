...
public class INFO_EMP{
    ...
    public void beforetest(){
        ...
        ExtentSparkReporter htmlReporter = new  ExtentSparkReporter("C://Users//asus//Desktop//java practice//ORANGEHRM_PROJECTQA//src//main//java//REPORT_DOCUMENTATION//EXTENT//info.html");
    ...
    public void writeDataToCSV() throws IOException {
        String filePath = "C://Users//asus//Desktop//java practice//ORANGEHRM_PROJECTQA//CSVFILE//user2.csv";
    ...
    //static EMPLOYEE_PAGE EMPLOYEE_PAGE;
    ...
    @Test(priority = 3, description = "modifying employee info")
    ...
    @Test(priority = 4, description = "upload attachement")
    ...
    @Test(priority = 5, description = "change profile picture")
